...
function createTeamsCallback(train) {
  return function(result) {
    ...
    return Promise.all( reqs ).then( function(reqs){ console.log('All users retrieved'); } );
  };
}
...
function createTrainCallback(trains) {
  return function(result) {
    ...
    return Promise.all( reqs ).then( function(reqs){ console.log('All Teams retrieved !!!'); } );
  };
}
...
function createTrainsCallback(trains) {
  return function(result) {
    ...
    return Promise.all( reqs ).then( function(reqs){ console.log('All Trains are retrieved !!!'); } );
  };
}
